 ...
 *
 * The SawinGraphics class is used to create the GUI
 * for the SawinInternationalBank.
 *
 */
public class SawinGraphics extends JFrame implements ActionListener
{
	...
	private final ImageIcon[] images = {new ImageIcon("src/SawinInternational.png"),new ImageIcon("src/SawinInternationalDriveThru.png")};
	public Music music = new Music("src/SawinInternational.wav");
	...
	public void createAndShowGUI() throws IOException
	{
		...
		this.setSize(910, 497);
		this.setContentPane(lpane);
		this.setVisible(true);
		this.setLocationRelativeTo(null);
		this.setTitle("Sawin International");
		music.start();
	...
	//absolute layout positioning
		...
		this.musicIcon.setIcon(new ImageIcon("src/musicIcon.png"));
